...
export interface Contact {
  ...
  user_id: string;
  account_id: string;
  /** Nullable since migration 038 — a contact can exist with only an
   *  email (e.g. a Sistemas/IT decisor with no phone on file). */
  phone: string | null;
  ...
  company?: string;
  avatar_url?: string;
  /** Migration 038 — commercial CRM fields, all optional/nullable. */
...
// ------------------------------------------------------------
// Commercial CRM (migration 038) — institutions, decision levels,
// phone/email multiplicity + manual verification, meetings.
// ------------------------------------------------------------
...
export type PhoneType = "CELULAR" | "FIJO" | "DESCONOCIDO";
export type Confidence = "ALTA" | "MEDIA" | "BAJA" | "REQUIERE_REVISION_MANUAL";
export type MeetingType = "PRESENCIAL" | "TELEFONICA" | "VIDEOLLAMADA";
export type MeetingStatus = "PROPUESTA" | "AGENDADA" | "REALIZADA" | "CANCELADA";
export type Potential = "NO_DETERMINADO" | "BAJO" | "MEDIO" | "ALTO";
export type RelationshipStrength = "ALTA" | "MEDIA" | "BAJA";
...
export interface OrganizationContact {
  ...
  created_at: string;
  updated_at: string;
  /** Hydrated by queries that embed contacts(*) or organizations(*). */
  contact?: Contact;
  organization?: Organization;
}

/** Row shape returned by the `get_organization_decision_map` RPC. */
export interface OrganizationDecisionMapRow {
  contact_id: string;
...
export interface ContactPhone {
  ...
  phone_digits_only?: string | null;
  phone_e164?: string | null;
  area_code_original?: string | null;
  locality?: string | null;
  province?: string | null;
